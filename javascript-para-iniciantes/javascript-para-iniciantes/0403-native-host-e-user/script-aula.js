...
// Construtores de objetos nativo:
...
// === Host ===
/* Objetos do host são aqueles implementados pelo próprio ambiente. Por exemplo, no browser possuímos objetos do DOM, como DomList, HTMLCollection e outros. Em Node.js os objetos do ost são diferentes, já que não estamos em um ambiente do browser. */
...
// === Bibliotecas ===
/* Bibliotecas como jQuery foram criadas para resolver o problema de inconsistências entre browsers e adicionar funcionalidades que não existiam nativamente. A padronização dos browsers e a implementação de soluções nativas, torna as mesmas obsoletas. Ex:
...
console.log(typeof Array.from !== "undefined"); // true
console.log(typeof NodeList !== "undefined"); // true
console.log(typeof example !== "undefined"); // false
